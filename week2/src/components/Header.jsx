...
const Header = () => {
  return (
    <div>
      <div id='header'>
        <div className='front'>
          <Txtpurple>회원가입</Txtpurple>
          <Line></Line>
          <div className='a2'>로그인</div>
          <Line></Line>
          <div className='scroll'>
            <span className='a3'>고객센터
            <img src='https://res.kurly.com/pc/ico/1908/ico_down_16x10.png' className='scroll-btn'></img>
            </span>
            <div className='open-a3'>
                <p>공지사항</p>
                <p>자주하는 질문</p>
                <p>1:1 문의</p>
                <p>대량주문 문의</p>
